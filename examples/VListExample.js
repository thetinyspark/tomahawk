...
Main.prototype._completeHandler = function(event)
{
	...
	var prop = null;
	var list = new tomahawk_ns.VList();
	...
	document.getElementById("prevBtn").addEventListener("click", list.up.bind(list));
	document.getElementById("nextBtn").addEventListener("click", list.down.bind(list));
};
