...
Matrix4x4.prototype.a = 0;
Matrix4x4.prototype.b = 0;
Matrix4x4.prototype.c = 0;
Matrix4x4.prototype.d = 0;
Matrix4x4.prototype.tx = 0;
Matrix4x4.prototype.ty = 0;
...
{
	return matrix.clone().multiply(this);
};
...
Matrix4x4.prototype.appendTransform = function(	x, 
												...
												rotationZ)
{
	return this.translate(x,y,z).scale(scaleX,scaleY,scaleZ).rotateX(rotationX).rotateY(rotationY).rotateZ(rotationZ);
};
...
Matrix4x4.prototype.transformPoint = function(x,y)
{
	var pt = new Object();
	pt.x = x*this.a+y*this.c+this.tx;
	pt.y = x*this.b+y*this.d+this.ty;
...
(function() {
	...
	Word.prototype.refresh = function()
	{
		...
		this.width = currentX + currentLetter.width;
